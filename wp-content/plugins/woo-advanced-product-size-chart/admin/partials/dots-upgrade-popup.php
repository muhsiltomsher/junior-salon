...
$plugin_slug = 'size_chart';
$get_discounts_api = SCFW_STORE_URL . 'wp-json/dots-upgrade-plugin-discounts/v2/dots-upgrade-plugin-discounts?' . wp_rand();
        ...
        <div class="pro-modal-inner">
            <div class="pro-modal-wrapper">
                <div class="pro-modal-header">
                    <img src="<?php echo esc_url( SCFW_PLUGIN_URL . 'admin/images/premium-upgrade-img/upgrade-rocket-img.png' ); ?>" alt="<?php esc_attr_e( 'Upgrade to Pro', 'size-chart-for-woocommerce' ); ?>">
                ...
                <div class="pro-modal-body">
                    ...
                    if ( ! empty( $discount_number ) ) {
                        ?>
                        <h3 class="pro-feature-title"><?php echo sprintf( esc_html__( 'Unlock Premium Features with a %s%% Discount!', 'size-chart-for-woocommerce' ), esc_html( $discount_number ) ); ?></h3>
                        <?php
                    } else {
                        ?>
                        <h3 class="pro-feature-title"><?php echo esc_html__( 'Unlock Premium Features Today!', 'size-chart-for-woocommerce' ); ?></h3>
                        <?php
                    }
                    ?>
                    <p><?php esc_html_e( 'Unlock a world of possibilities for your WooCommerce store with our Premium Product Size Charts plugin!', 'size-chart-for-woocommerce' ) ?></p>
                    <ul class="pro-feature-list">
                        <li><?php esc_html_e( 'Reduce returns by eliminating size-related issues.', 'size-chart-for-woocommerce' ); ?></li>
                        <li><?php esc_html_e( 'Minimizes customer confusion about sizes and fittings.', 'size-chart-for-woocommerce' ); ?></li>
                        <li><?php esc_html_e( 'Customers can view size charts easily before making purchases.', 'size-chart-for-woocommerce' ); ?></li>
                    </ul>
                </div>
                <div class="pro-modal-footer">
                    <a class="pro-feature-trial-btn upgrade-now" target="_blank" href="javascript:void(0);"><?php esc_html_e( 'Upgrade Now', 'size-chart-for-woocommerce' ) ?></a>
                </div>
            </div>
        </div>
    </div>
