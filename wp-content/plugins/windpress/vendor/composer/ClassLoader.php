 ...
 */
namespace WindPressDeps\Composer\Autoload;
...
class ClassLoader
{
    ...
    public function getPrefixes()
    {
        if (!empty($this->prefixesPsr0)) {
            return \call_user_func_array('WindPressDeps\\array_merge', \array_values($this->prefixesPsr0));
        }
        return array();
    }
    /**
    ...
    public function findFile($class)
    {
        ...
        if (\false === $file && \defined('WindPressDeps\\HHVM_VERSION')) {
