...
class Compile
{
    ...
    public function get_contents($metadata) : array
    {
        ...
        $wpQuery = new WP_Query(['posts_per_page' => \apply_filters('f!windpress/integration/greenshift/compile:get_contents.post_per_page', (int) \get_option('posts_per_page', 10)), 'post_type' => $post_types, 'paged' => $next_batch]);
