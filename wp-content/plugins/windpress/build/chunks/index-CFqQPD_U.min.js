...
var _ = { color: v, length: w, percentage: C, ratio: j, number: N, integer: p, url: z, position: Q$1, "bg-size": X, "line-width": I$1, image: H, "family-name": q$1, "generic-name": P, "absolute-size": B$1, "relative-size": W, angle: ee$1, vector: re$1 };
function pe$1(e, r) {
  var _a2;
  ...
  for (let c = 0; c < r.length; c++) {
    ...
    if (m === $e) l2 += r.slice(c, c + 2), c += 1;
      ...
      if (m === pe) {
        ...
        } else if (w2 === -1 && u2 === qr) w2 = l2.length + A2 - h2;
...
function he(r, t, i = 3) {
  ...
  if (w2 = w2.concat(e), i & 2) for (let [v2, A2] of l2) for (let k2 of A2) {
    ...
    let R2 = { ...k2, value: Y(V2) }, O2 = B("@supports (color: color-mix(in lab, red, red))", [k2]);
...
var li = /* @__PURE__ */ new Set(["inset", "inherit", "initial", "revert", "unset"]), Yt = /^-?(\d+|\.\d+)(.*?)$/g;
function Te(r, t) {
  return g(r, ",").map((e) => {
    e = e.trim();
    let o = g(e, " ").filter((c) => c.trim() !== ""), s2 = null, l2 = null, d2 = null;
    for (let c of o) li.has(c) || (Yt.test(c) ? (l2 === null ? l2 = c : d2 === null && (d2 = c), Yt.lastIndex = 0) : s2 === null && (s2 = c));
    if (l2 === null || d2 === null) return e;
    let u2 = t(s2 ?? "currentcolor");
    return s2 !== null ? e.replace(s2, u2) : `${e} ${u2}`;
  }).join(", ");
}
var si = /^-?[a-z][a-zA-Z0-9/%._-]*$/, ui = /^-?[a-z][a-zA-Z0-9/%._-]*-\*$/, Ge = ["0", "0.5", "1", "1.5", "2", "2.5", "3", "3.5", "4", "5", "6", "7", "8", "9", "10", "11", "12", "14", "16", "20", "24", "28", "32", "36", "40", "44", "48", "52", "56", "60", "64", "72", "80", "96"], pt = class {
  constructor() {
...
function er(r) {
  ...
  function l2(n, f2, p2, { supportsNegative: x = false, supportsFractions: y2 = false } = {}) {
    x && t.static(`-${n}-px`, () => p2("-1px")), t.static(`${n}-px`, () => p2("1px")), o(n, { themeKeys: f2, supportsFractions: y2, supportsNegative: x, defaultValue: null, handleBareValue: ({ value: C2 }) => {
      ...
      return !K2 || !ue$1(C2) ? null : `calc(${K2} * ${C2})`;
  ...
  e("size-auto", [["--tw-sort", "size"], ["width", "auto"], ["height", "auto"]]), e("w-auto", [["width", "auto"]]), e("h-auto", [["height", "auto"]]), e("min-w-auto", [["min-width", "auto"]]), e("min-h-auto", [["min-height", "auto"]]), e("h-lh", [["height", "1lh"]]), e("min-h-lh", [["min-height", "1lh"]]), e("max-h-lh", [["max-height", "1lh"]]), e("w-screen", [["width", "100vw"]]), e("min-w-screen", [["min-width", "100vw"]]), e("max-w-screen", [["max-width", "100vw"]]), e("h-screen", [["height", "100vh"]]), e("min-h-screen", [["min-height", "100vh"]]), e("max-h-screen", [["max-height", "100vh"]]), e("max-w-none", [["max-width", "none"]]), e("max-h-none", [["max-height", "none"]]), l2("size", ["--size", "--spacing"], (n) => [a("--tw-sort", "size"), a("width", n), a("height", n)], { supportsFractions: true });
  ...
  let d2 = () => D([$("--tw-border-spacing-x", "0", "<length>"), $("--tw-border-spacing-y", "0", "<length>")]);
  ...
  let u2 = () => D([$("--tw-translate-x", "0"), $("--tw-translate-y", "0"), $("--tw-translate-z", "0")]);
  ...
  {
    let n = ["var(--tw-rotate-x,)", "var(--tw-rotate-y,)", "var(--tw-rotate-z,)", "var(--tw-skew-x,)", "var(--tw-skew-y,)"].join(" "), f2 = () => D([$("--tw-rotate-x"), $("--tw-rotate-y"), $("--tw-rotate-z"), $("--tw-skew-x"), $("--tw-skew-y")]);
  ...
  let h2 = () => D([$("--tw-pan-x"), $("--tw-pan-y"), $("--tw-pinch-zoom")]);
  ...
  let w2 = () => D([$("--tw-scroll-snap-strictness", "proximity", "*")]);
      ...
      t.functional(p$1, (y2) => {
        ...
        if (y2.value.kind === "arbitrary") {
          ...
          switch (y2.value.dataType ?? pe$1(C2, ["color", "line-width", "length"])) {
            ...
            default:
              return C2 = Z(C2, y2.modifier, r), C2 === null ? void 0 : x.color(C2);
          }
        }
        {
          let C2 = Q(y2, r, ["--border-color", "--color"]);
  ...
  let v2 = () => D([$("--tw-gradient-position"), $("--tw-gradient-from", "#0000", "<color>"), $("--tw-gradient-via", "#0000", "<color>"), $("--tw-gradient-to", "#0000", "<color>"), $("--tw-gradient-stops"), $("--tw-gradient-via-stops"), $("--tw-gradient-from-position", "0%", "<length-percentage>"), $("--tw-gradient-via-position", "50%", "<length-percentage>"), $("--tw-gradient-to-position", "100%", "<length-percentage>")]);
  function A2(n, f2) {
    t.functional(n, (p$1) => {
      if (p$1.value) {
  ...
  let k2 = () => D([$("--tw-mask-linear", "linear-gradient(#fff, #fff)"), $("--tw-mask-radial", "linear-gradient(#fff, #fff)"), $("--tw-mask-conic", "linear-gradient(#fff, #fff)")]);
  function b2(n, f2) {
    t.functional(n, (p$1) => {
      if (p$1.value) {
        if (p$1.value.kind === "arbitrary") {
  ...
  let V2 = () => D([$("--tw-mask-left", "linear-gradient(#fff, #fff)"), $("--tw-mask-right", "linear-gradient(#fff, #fff)"), $("--tw-mask-bottom", "linear-gradient(#fff, #fff)"), $("--tw-mask-top", "linear-gradient(#fff, #fff)")]);
  function S(n, f2, p2) {
    b2(n, { color(x) {
      ...
      for (let C2 of ["top", "right", "bottom", "left"]) p2[C2] && (y2.push(a(`--tw-mask-${C2}`, `linear-gradient(to ${C2}, var(--tw-mask-${C2}-from-color) var(--tw-mask-${C2}-from-position), var(--tw-mask-${C2}-to-color) var(--tw-mask-${C2}-to-position))`)), y2.push(D([$(`--tw-mask-${C2}-from-position`, "0%"), $(`--tw-mask-${C2}-to-position`, "100%"), $(`--tw-mask-${C2}-from-color`, "black"), $(`--tw-mask-${C2}-to-color`, "transparent")])), y2.push(a(`--tw-mask-${C2}-${f2}-color`, x)));
      return y2;
    }, position(x) {
      let y2 = [k2(), V2(), a("mask-image", "var(--tw-mask-linear), var(--tw-mask-radial), var(--tw-mask-conic)"), a("mask-composite", "intersect"), a("--tw-mask-linear", "var(--tw-mask-left), var(--tw-mask-right), var(--tw-mask-bottom), var(--tw-mask-top)")];
  ...
  let R2 = () => D([$("--tw-mask-linear-position", "0deg"), $("--tw-mask-linear-from-position", "0%"), $("--tw-mask-linear-to-position", "100%"), $("--tw-mask-linear-from-color", "black"), $("--tw-mask-linear-to-color", "transparent")]);
  ...
  let O2 = () => D([$("--tw-mask-radial-from-position", "0%"), $("--tw-mask-radial-to-position", "100%"), $("--tw-mask-radial-from-color", "black"), $("--tw-mask-radial-to-color", "transparent"), $("--tw-mask-radial-shape", "ellipse"), $("--tw-mask-radial-size", "farthest-corner"), $("--tw-mask-radial-position", "center")]);
  ...
  let U2 = () => D([$("--tw-mask-conic-position", "0deg"), $("--tw-mask-conic-from-position", "0%"), $("--tw-mask-conic-to-position", "100%"), $("--tw-mask-conic-from-color", "black"), $("--tw-mask-conic-to-color", "transparent")]);
    ...
    if (!(!n.value || n.modifier)) {
      if (n.value.kind === "arbitrary") {
        ...
        switch (n.value.dataType ?? pe$1(f2, ["number", "generic-name", "family-name"])) {
          ...
          default:
            return [D([$("--tw-font-weight")]), a("--tw-font-weight", f2), a("font-weight", f2)];
        }
      }
      {
      ...
      }
      {
        ...
        if (f2) return [D([$("--tw-font-weight")]), a("--tw-font-weight", f2), a("font-weight", f2)];
      }
    }
  ...
  {
    let n = ["var(--tw-blur,)", "var(--tw-brightness,)", "var(--tw-contrast,)", "var(--tw-grayscale,)", "var(--tw-hue-rotate,)", "var(--tw-invert,)", "var(--tw-saturate,)", "var(--tw-sepia,)", "var(--tw-drop-shadow,)"].join(" "), f2 = ["var(--tw-backdrop-blur,)", "var(--tw-backdrop-brightness,)", "var(--tw-backdrop-contrast,)", "var(--tw-backdrop-grayscale,)", "var(--tw-backdrop-hue-rotate,)", "var(--tw-backdrop-invert,)", "var(--tw-backdrop-opacity,)", "var(--tw-backdrop-saturate,)", "var(--tw-backdrop-sepia,)"].join(" "), p$1 = () => D([$("--tw-blur"), $("--tw-brightness"), $("--tw-contrast"), $("--tw-grayscale"), $("--tw-hue-rotate"), $("--tw-invert"), $("--tw-opacity"), $("--tw-saturate"), $("--tw-sepia"), $("--tw-drop-shadow"), $("--tw-drop-shadow-color"), $("--tw-drop-shadow-alpha", "100%", "<percentage>"), $("--tw-drop-shadow-size")]), x = () => D([$("--tw-backdrop-blur"), $("--tw-backdrop-brightness"), $("--tw-backdrop-contrast"), $("--tw-backdrop-grayscale"), $("--tw-backdrop-hue-rotate"), $("--tw-backdrop-invert"), $("--tw-backdrop-opacity"), $("--tw-backdrop-saturate"), $("--tw-backdrop-sepia")]);
    t.functional("filter", (y2) => {
      ...
      if (y2.modifier && (y2.modifier.kind === "arbitrary" ? C2 = y2.modifier.value : p(y2.modifier.value) && (C2 = `${y2.modifier.value}%`)), !y2.value) {
        ...
        return K2 === null || N2 === null ? void 0 : [p$1(), a("--tw-drop-shadow-alpha", C2), ...qe("--tw-drop-shadow-size", K2, C2, (T2) => `var(--tw-drop-shadow-color, ${T2})`), a("--tw-drop-shadow", g(N2, ",").map((T2) => `drop-shadow(${T2})`).join(" ")), a("filter", n)];
      }
      if (y2.value.kind === "arbitrary") {
        let K2 = y2.value.value;
        switch (y2.value.dataType ?? pe$1(K2, ["color"])) {
          case "color":
            return K2 = Z(K2, y2.modifier, r), K2 === null ? void 0 : [p$1(), a("--tw-drop-shadow-color", J(K2, "var(--tw-drop-shadow-alpha)")), a("--tw-drop-shadow", "var(--tw-drop-shadow-size)")];
          default:
            return y2.modifier && !C2 ? void 0 : [p$1(), a("--tw-drop-shadow-alpha", C2), ...qe("--tw-drop-shadow-size", K2, C2, (T2) => `var(--tw-drop-shadow-color, ${T2})`), a("--tw-drop-shadow", "var(--tw-drop-shadow-size)"), a("filter", n)];
        }
      }
      {
        let K2 = r.get([`--drop-shadow-${y2.value.value}`]), N2 = r.resolve(y2.value.value, ["--drop-shadow"]);
        if (K2 && N2) return y2.modifier && !C2 ? void 0 : C2 ? [p$1(), a("--tw-drop-shadow-alpha", C2), ...qe("--tw-drop-shadow-size", K2, C2, (T2) => `var(--tw-drop-shadow-color, ${T2})`), a("--tw-drop-shadow", "var(--tw-drop-shadow-size)"), a("filter", n)] : [p$1(), a("--tw-drop-shadow-alpha", C2), ...qe("--tw-drop-shadow-size", K2, C2, (T2) => `var(--tw-drop-shadow-color, ${T2})`), a("--tw-drop-shadow", g(N2, ",").map((T2) => `drop-shadow(${T2})`).join(" ")), a("filter", n)];
      }
      {
        let K2 = Q(y2, r, ["--drop-shadow-color", "--color"]);
        if (K2) return K2 === "inherit" ? [p$1(), a("--tw-drop-shadow-color", "inherit"), a("--tw-drop-shadow", "var(--tw-drop-shadow-size)")] : [p$1(), a("--tw-drop-shadow-color", J(K2, "var(--tw-drop-shadow-alpha)")), a("--tw-drop-shadow", "var(--tw-drop-shadow-size)")];
      }
  ...
  e("will-change-auto", [["will-change", "auto"]]), e("will-change-scroll", [["will-change", "scroll-position"]]), e("will-change-contents", [["will-change", "contents"]]), e("will-change-transform", [["will-change", "transform"]]), o("will-change", { themeKeys: [], handle: (n) => [a("will-change", n)] }), e("content-none", [["--tw-content", "none"], ["content", "none"]]), o("content", { themeKeys: [], handle: (n) => [D([$("--tw-content", '""')]), a("--tw-content", n), a("content", "var(--tw-content)")] });
  {
    let n = "var(--tw-contain-size,) var(--tw-contain-layout,) var(--tw-contain-paint,) var(--tw-contain-style,)", f2 = () => D([$("--tw-contain-size"), $("--tw-contain-layout"), $("--tw-contain-paint"), $("--tw-contain-style")]);
  ...
  e("forced-color-adjust-none", [["forced-color-adjust", "none"]]), e("forced-color-adjust-auto", [["forced-color-adjust", "auto"]]), e("leading-none", [() => D([$("--tw-leading")]), ["--tw-leading", "1"], ["line-height", "1"]]), l2("leading", ["--leading", "--spacing"], (n) => [D([$("--tw-leading")]), a("--tw-leading", n), a("line-height", n)]), o("tracking", { supportsNegative: true, themeKeys: ["--tracking"], handle: (n) => [D([$("--tw-tracking")]), a("--tw-tracking", n), a("letter-spacing", n)] }), e("antialiased", [["-webkit-font-smoothing", "antialiased"], ["-moz-osx-font-smoothing", "grayscale"]]), e("subpixel-antialiased", [["-webkit-font-smoothing", "auto"], ["-moz-osx-font-smoothing", "auto"]]);
  {
    let n = "var(--tw-ordinal,) var(--tw-slashed-zero,) var(--tw-numeric-figure,) var(--tw-numeric-spacing,) var(--tw-numeric-fraction,)", f2 = () => D([$("--tw-ordinal"), $("--tw-slashed-zero"), $("--tw-numeric-figure"), $("--tw-numeric-spacing"), $("--tw-numeric-fraction")]);
  ...
  {
    let n = () => D([$("--tw-outline-style", "solid")]);
  ...
  let P2 = () => D([$("--tw-text-shadow-color"), $("--tw-text-shadow-alpha", "100%", "<percentage>")]);
  ...
  }), i("text-shadow", () => [{ values: ["current", "inherit", "transparent"], valueThemeKeys: ["--text-shadow-color", "--color"], modifiers: Array.from({ length: 21 }, (n, f2) => `${f2 * 5}`) }, { values: ["none"] }, { valueThemeKeys: ["--text-shadow"], modifiers: Array.from({ length: 21 }, (n, f2) => `${f2 * 5}`), hasDefaultValue: r.get(["--text-shadow"]) !== null }]);
  {
    ...
    let n = ["var(--tw-inset-shadow)", "var(--tw-inset-ring-shadow)", "var(--tw-ring-offset-shadow)", "var(--tw-ring-shadow)", "var(--tw-shadow)"].join(", "), f2 = "0 0 #0000", p$1 = () => D([$("--tw-shadow", f2), $("--tw-shadow-color"), $("--tw-shadow-alpha", "100%", "<percentage>"), $("--tw-inset-shadow", f2), $("--tw-inset-shadow-color"), $("--tw-inset-shadow-alpha", "100%", "<percentage>"), $("--tw-ring-color"), $("--tw-ring-shadow", f2), $("--tw-inset-ring-color"), $("--tw-inset-ring-shadow", f2), $("--tw-ring-inset"), $("--tw-ring-offset-width", "0px", "<length>"), $("--tw-ring-offset-color", "#fff"), $("--tw-ring-offset-shadow", f2)]);
    ...
    }), i("inset-shadow", () => [{ values: ["current", "inherit", "transparent"], valueThemeKeys: ["--box-shadow-color", "--color"], modifiers: Array.from({ length: 21 }, (N2, T2) => `${T2 * 5}`) }, { values: ["none"] }, { valueThemeKeys: ["--inset-shadow"], modifiers: Array.from({ length: 21 }, (N2, T2) => `${T2 * 5}`), hasDefaultValue: r.get(["--inset-shadow"]) !== null }]), e("ring-inset", [p$1, ["--tw-ring-inset", "inset"]]);
    ...
    t.functional("ring", (N2) => {
      ...
      if (!N2.value) return N2.modifier ? void 0 : [p$1(), a("--tw-inset-ring-shadow", C2("1px")), a("box-shadow", n)];
      if (N2.value.kind === "arbitrary") {
        let T2 = N2.value.value;
        switch (N2.value.dataType ?? pe$1(T2, ["color", "length"])) {
          case "length":
            return N2.modifier ? void 0 : [p$1(), a("--tw-inset-ring-shadow", C2(T2)), a("box-shadow", n)];
          default:
      ...
      }
      {
        if (N2.modifier) return;
        let T2 = r.resolve(N2.value.value, ["--ring-width"]);
        if (T2 === null && p(N2.value.value) && (T2 = `${N2.value.value}px`), T2) return [p$1(), a("--tw-inset-ring-shadow", C2(T2)), a("box-shadow", n)];
      }
...
`);
      ...
      for (let [l2, { literals: d2, usedSpacingNumber: u2, usedSpacingInteger: c, themeKeys: m }] of [[o, e["--value"]], [s2, e["--modifier"]]]) {
        ...
        for (let g2 of i.theme.keysInNamespaces(m)) l2.push(g2.replace(Xt, (h2, w2, v2) => `${w2}.${v2}`));
      }
...
function nr(r) {
  ...
  for (let e of r.utilities.keys("functional")) {
    ...
    for (let s2 of o) for (let l2 of s2.values) {
      let d2 = l2 !== null && hi.test(l2), u2 = l2 === null ? e : `${e}-${l2}`;
...
function sr(r) {
  ...
  i("first", ["&:first-child"]), i("last", ["&:last-child"]), i("only", ["&:only-child"]), i("odd", ["&:nth-child(odd)"]), i("even", ["&:nth-child(even)"]), i("first-of-type", ["&:first-of-type"]), i("last-of-type", ["&:last-of-type"]), i("only-of-type", ["&:only-of-type"]), i("visited", ["&:visited"]), i("target", ["&:target"]), i("open", ["&:is([open], :popover-open, :open)"]), i("default", ["&:default"]), i("checked", ["&:checked"]), i("indeterminate", ["&:indeterminate"]), i("placeholder-shown", ["&:placeholder-shown"]), i("autofill", ["&:autofill"]), i("optional", ["&:optional"]), i("required", ["&:required"]), i("valid", ["&:valid"]), i("invalid", ["&:invalid"]), i("user-valid", ["&:user-valid"]), i("user-invalid", ["&:user-invalid"]), i("in-range", ["&:in-range"]), i("out-of-range", ["&:out-of-range"]), i("read-only", ["&:read-only"]), i("empty", ["&:empty"]), i("focus-within", ["&:focus-within"]), t.static("hover", (c) => {
    ...
    m.value.kind === "arbitrary" ? c.nodes = [L(`&[aria-${lr(m.value.value)}]`, c.nodes)] : c.nodes = [L(`&[aria-${m.value.value}="true"]`, c.nodes)];
  }), t.suggest("aria", () => ["busy", "checked", "disabled", "expanded", "hidden", "pressed", "readonly", "required", "selected"]), t.functional("data", (c, m) => {
    if (!m.value || m.modifier) return null;
    c.nodes = [L(`&[data-${lr(m.value.value)}]`, c.nodes)];
...
function ur(r) {
  let t = er(r), i = sr(r), e = new q((u2) => Jt(u2, d2)), o = new q((u2) => Array.from(Gt(u2, d2))), s2 = new q((u2) => {
    let c = fr(u2, d2);
    try {
...
function wi(r, t) {
  ...
  let i = t.utilities.get(r.root) ?? [], e = [], o = i.filter((l2) => !cr(l2));
  for (let l2 of o) {
  ...
  return F(r, (l2, { replaceWith: d2 }) => {
    if (l2.kind === "at-rule" && (l2.name === "@import" || l2.name === "@reference")) {
      ...
      return s2.push((async () => {
        ...
        await yt(A2, v2.base, i, e + 1), w2.nodes = bi([ne({ base: v2.base }, A2)], m, g2, h2);
      })()), d2(w2), 1;
    }
  ...
  return function(o, s2) {
    ...
    let u2 = (() => {
      ...
      if (h2 !== null && typeof h2 == "object" && !Array.isArray(h2)) {
        ...
        for (let v2 in m) v2 !== "__CSS_VALUES__" && (((_a2 = h2 == null ? void 0 : h2.__CSS_VALUES__) == null ? void 0 : _a2[v2]) & 4 && hr(w2, v2.split("-")) !== void 0 || (w2[ge(v2)] = m[v2]));
        return w2;
      }
...
function Ni(r, t) {
  ...
  for (let [m, g2] of l2) vr(c, [m ?? "DEFAULT"], g2);
    ...
    switch (d2) {
      ...
      case Cr: {
        ...
        if (o = "", u2.value !== ":not" && u2.value !== ":where" && u2.value !== ":has" && u2.value !== ":is") {
          ...
          let g2 = l2;
          u2.nodes.push(Ei(r.slice(c, g2))), o = "", l2 = g2, e ? e.nodes.push(u2) : t.push(u2);
          break;
        }
      ...
      case Pi: {
        let u2 = l2;
        for (let c = l2 + 1; c < r.length; c++) if (s2 = r.charCodeAt(c), s2 === wr) c += 1;
        else if (s2 === d2) {
          l2 = c;
          break;
        }
...
\`@plugin\` options must be a flat list of declarations.`);
          ...
          let V2 = b2.value, S = g(V2, ",").map((R2) => {
            ...
            if (Number.isNaN(Number(R2))) {
              ...
              if (R2[0] === "{" && R2[R2.length - 1] === "}") throw new Error(`Unexpected \`@plugin\` option: Value of declaration \`${re([b2]).trim()}\` is not supported.
...
function Ir({ designSystem: r, base: t, ast: i, sources: e, configs: o, pluginDetails: s2 }) {
  ...
  if (mr(r, m, g2), Kr(r, m), Ur(m, r), Dr(m, r), Or(m, r), !r.theme.prefix && c.prefix) {
...
async function Lr(r, { base: t = "", loadModule: i = Ji, loadStylesheet: e = Hi } = {}) {
  ...
  F(r, (b2, { parent: V2, replaceWith: S, context: R2 }) => {
    if (b2.kind === "at-rule") {
      ...
      if (b2.name === "@media") {
        ...
        for (let P2 of O2) if (P2.startsWith("source(")) {
          ...
          F(b2.nodes, (M2, { replaceWith: z2 }) => {
            if (M2.kind === "at-rule" && M2.name === "@tailwind" && M2.params === "utilities") return M2.params += ` source(${H2})`, z2([ne({ sourceBase: R2.base }, [M2])]), 2;
          });
...
${H2}`);
  ...
  if (g$1.length > 0) {
    for (let b2 of g$1) {
      let V2 = L("&", b2.nodes), S = b2.params, R2 = k2.parseVariant(S);
...
async function Zi(r, t = {}) {
  let { designSystem: i, ast: e, sources: o, root: s2, utilitiesNode: l2, features: d2, inlineCandidates: u2 } = await Lr(r, t);
