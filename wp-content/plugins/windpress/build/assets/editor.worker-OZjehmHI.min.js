(function () {
    ...
    else if (typeof process$1 !== 'undefined' && typeof process$1?.versions?.node === 'string') {
        // Native environment (non-sandboxed)
        nodeProcess = process$1;
    }
    ...
    */
    ...
    if (typeof vscodeGlobal !== "undefined" && typeof vscodeGlobal.process !== "undefined") {
      ...
      safeProcess = {
        ...
        get arch() {
          return process$1.arch;
        },
        get env() {
          return define_process_env_default;
        },
        cwd() {
          return define_process_env_default["VSCODE_CWD"] || process$1.cwd();
        }
      };
    } else {
      safeProcess = {
