...
<div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-5 gap-6">
    ...
    if ($query->have_posts()) :
        while ($query->have_posts()) : $query->the_post();
            ...
            ?>
            <div id="product-grid" class="product-card bg-white p-4 rounded-lg shadow hover:shadow-lg transition">
...
jQuery(document).ready(function($) {
   ...
   // alert("dd");
        ...
        fetch_sorted_products_by_category(currentSort, page); // Fetch products for the next page
    });
